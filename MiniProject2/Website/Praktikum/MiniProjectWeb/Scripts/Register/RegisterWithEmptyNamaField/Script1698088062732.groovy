...
WebUI.setText(findTestObject('Register/Nama Lengkap Field'), '')

WebUI.setText(findTestObject('Register/Email Field'), 'atunggmail.com')

WebUI.setText(findTestObject('Register/Password Field'), 'sama')

WebUI.click(findTestObject('Register/Register Button'))

WebUI.verifyElementPresent(findTestObject('Register/Alert Fullname'), 0)
